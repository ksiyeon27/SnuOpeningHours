                ...
                : function (t, n, s) {
                    ...
                    if (v) {
                      ...
                      if (((h = [a ? v.firstChild : v.lastChild]), a && m)) {
                        (b =
                          (p =
                            (l = (c = (f = (d = v)[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === C &&
                            l[1]) && l[2]),
                          (d = p && v.childNodes[p]);
                        ...
                        (m &&
                          (b = p =
                            (l = (c = (f = (d = t)[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === C &&
                            l[1]),
                        !1 === b)
                      )
                        while ((d = (++p && d && d[g]) || (b = p = 0) || h.pop()))
        ...
        : function (t, n, s) {
            ...
            if (s) {
              ...
              while ((t = t[r]))
                if (1 === t.nodeType || a)
                  if (
                    ((f = t[x] || (t[x] = {})), (c = f[t.uniqueID] || (f[t.uniqueID] = {})), i && i === t.nodeName.toLowerCase())
                  )
                    t = t[r] || t;
                  else {
      ...
      serializeArray: function () {
        return this.map(function () {
          ...
          .filter(function () {
            var e = this.type;
            return (
              this.name && !w(this).is(":disabled") && ht.test(this.nodeName) && !pt.test(e) && (this.checked || !de.test(e))
            );
          })
          .map(function (e, t) {
            var n = w(this).val();
